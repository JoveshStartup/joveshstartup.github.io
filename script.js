document.addEventListener('DOMContentLoaded', () => {
    ...
    document.querySelectorAll('.nav-links a, .header-cta a').forEach(anchor => {
        anchor.addEventListener('click', function (e) {
            const href = this.getAttribute('href');
            
            // Only use smooth scroll for on-page anchor links (starting with #)
            if (href.startsWith('#')) {
                e.preventDefault();
            ...
            // If it's a link to another page (like index.html#something), let the browser handle it normally
        });
    });
